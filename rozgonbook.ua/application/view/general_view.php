    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                <div class="logo"><a href="http://rozgonbook.ua/admin" class="navbar-brand"><span
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <form class="navbar-form navbar-right">
                            <div class="form-group">
                                <input id="search" type="text" name="search" placeholder="Найти книгу" class="form-control" value="<?php echo $search; ?>">
                                <script>
                                    $("#search").bind("keypress", function (e) {
                                        if (e.keyCode == 13) {
                                            let result = new XMLHttpRequest();
                                            result.open("GET", "/?search=" + #name, true);
                                            result.send();
                                        }
                                    })
                                </script>
            ...
            <div class="col-xs-2 col-sm-3 col-md-2 col-lg-2 hidden-xs">
                <div class="social"><a href="https://www.facebook.com/shpp.kr/" target="_blank"><span
                        ...
                        href="http://programming.org.ua/ru/courses#faq" target="_blank"><span class="fa-stack fa-sm"><i
